...
person or people are visible in the scene and is dropping of a package, box or parcel.
...
CHUNK_OVERLAP = 0          # seconds of overlap between windows
...
def _parse_chunk(content: str) -> dict:
    ...
    try:
        ...
        return {
            "person_dropping_package_detected": bool(data.get("person_dropping_package_detected", False)),
